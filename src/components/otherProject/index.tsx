...
function OtherProject({ tools, github, website }: props) {
  return (
    <div className="px-[13px] py-[14px] flex flex-col justify-between gap-[23px] font-poppins bg-secondary-bg rounded-[5px] hover:shadow-glow transition-shadow">
      ...
      <div className="flex flex-col justify-between gap-[47px]">
        <div>
          <h3 className="text-xl font-medium mb-[10px]">Time Have More Fun</h3>
